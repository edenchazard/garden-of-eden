...
parentPort?.on('message', async function (message) {
    if (message.type !== 'banner')
        return;
    const { user, filePath, weeklyClicks, weeklyRank, allTimeClicks, allTimeRank, dragonCodes, resources, } = message;
    try {
        console.log('resources', resources);
        await generateBannerToTemporary(user, filePath, weeklyClicks, weeklyRank, allTimeClicks, allTimeRank, dragonCodes, resources);
...
// the meat of it
async function generateBannerToTemporary(user, filePath, weeklyClicks, weeklyRank, allTimeClicks, allTimeRank, dragonCodes, resources) {
    try {
